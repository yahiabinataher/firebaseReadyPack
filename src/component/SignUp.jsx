...
const SignUp = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if(!formData.acceptedTerms){
        ...
        myToast("Please accept our trams and condition")
        setLoading(false)
        return
    }
    //password validation
    ...
    if(!passwordRegex.test(formData.password)){
        setError('Put your password one Uppercase one lowercase and one number and one specicaractor')
       setLoading(false)
        return
    }
    ...
    .then((result) => {
      ...
      fetch("https://expressfast.vercel.app/user",{
        method:"POST",
        headers:{
      ...
      <div className="w-full max-w-md bg-white shadow-lg rounded-lg p-8">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4 flex items-center">
            <input
              ...
              onChange={handleChange}
            />
            <label htmlFor="acceptedTerms" className="ml-2 text-gray-700 text-sm">
              I accept the{" "}
        ...
        <div className="mt-6 text-center">
          ...
          <div className="mt-4 flex flex-col space-y-2">
            <button
              className="flex items-center justify-center w-full py-2 border border-gray-300 rounded-lg hover:bg-gray-100 transition duration-200"
              onClick={handleGmail}
            >
              <img
